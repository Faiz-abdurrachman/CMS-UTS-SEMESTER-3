-- ============================================
-- PENJELASAN FILE: create-admin.sql
-- ============================================
-- Fungsi: Contoh script SQL untuk membuat satu user admin secara manual. Password HARUS sudah
--         dalam bentuk hash (bcrypt). Biasanya admin dibuat lewat script createAdmin.js, bukan file ini.
-- Alur: Ganti nama, email, dan hash password di INSERT; jalankan di phpMyAdmin atau mysql client.
-- Analogi: Form isian manual untuk "tambah satu admin"; password harus sudah di-enkripsi (hash).
-- ============================================
...
-- ============================================
-- RINGKASAN: File referensi SQL untuk insert/update admin. Password harus hash, bukan plain text.
-- ISTILAH: Hash = hasil enkripsi satu arah (bcrypt); INSERT = tambah baris; UPDATE = ubah baris.
-- KESALAHAN PEMULA: Insert password plain text lalu login gagal (backend bandingkan dengan bcrypt); lupa ganti email/hash dengan nilai asli.
-- ============================================
