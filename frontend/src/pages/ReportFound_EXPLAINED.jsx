...
🧠 Fungsi: Sama seperti ReportLost tapi status "found" dan api.post("/items/found", data). Form + FormData; jangan set Content-Type manual.
🔄 Alur: Identik ReportLost; hanya endpoint dan label (Found Location, Date Found) yang beda.
📦 Analogi: Formulir "saya menemukan barang orang".
*/

// ============================================
// FILE: src/pages/ReportFound.jsx
// DESKRIPSI: Halaman untuk melaporkan barang ditemukan - Modern Design
// ============================================
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8 lg:p-10">
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
              Report an item you found in a random place (not yours). Help the
              original owner find their item. Your report will be validated by
              admin before appearing on the public dashboard.
            </p>
          </div>
          ...
          <form onSubmit={submit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., Campus Parking, Room 101, Main Street"
                className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all duration-200 text-gray-900 placeholder-gray-400"
                required
              />
              <p className="text-xs text-gray-500 mt-2">
                Location where you found this item
              </p>
            </div>
...
/*
---------- RINGKASAN: FormData + status "found"; api.post("/items/found", data). Same pattern as ReportLost.
---------- ISTILAH: Same as ReportLost.
---------- KESALAHAN PEMULA: Same as ReportLost (Content-Type manual).
*/
