...
/*
🔄 Alur eksekusi: State form/file/imagePreview/error/loading; handleImageChange (max 5MB, preview); submit → FormData (form + status "found" + image) → api.post("/items/found", data) → toast + navigate.
🧠 Ringkasan: Form lapor barang ditemukan; kirim sebagai FormData (multipart); status "found"; sukses ke dashboard.
📘 Glosarium: FormData, append, FileReader.readAsDataURL, accept="image/*", required.
⚠️ Kesalahan: Kirim JSON biasa dengan file → tidak bisa; harus FormData untuk upload file. Backend harus expect multipart.
*/
